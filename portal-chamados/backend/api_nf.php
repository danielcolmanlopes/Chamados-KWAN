...
try {
    ...
    $stmt = $mysqli->prepare('INSERT INTO notas_fiscais (numero, serie, estado_emissor, data_emissao, transportadora, percentual_icms, valor_icms, percentual_ipi, valor_ipi) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)');
    if (!$stmt) {
